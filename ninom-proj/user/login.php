      ...
      <div class="layout_padding2-top">
        <div class="row">
          <div class="col-lg-4 offset-lg-2 col-md-5 offset-md-1">
            <form action="../control/user/action.php?action=login" method="POST">
              <div class="contact_form-container">
                <div>
                  ...
                  <div>
                    <input type="password" placeholder="Passworld" name="userPasswd" />
                  </div>
                  <div>
                    <div>
                      <button type="submit">
                    ...
                    <div>New user?<a href="signup.php">Sign Up Here</a></div>
                  </div>
                </div>
            </form>
          </div>
