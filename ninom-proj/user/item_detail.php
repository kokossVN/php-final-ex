...
$item = $listProductdata->getProduct_id($_GET["ID"]);
...
?>
  ...
  <body class="sub_page">
    ...
    <!-- contact section -->
    <section class="item_session layout_padding">
      <div class="container">
        <div class="item_container">
          ...
          <div class="right_site">
            <form method="post" action="../control/user/action.php?action=orderEvent">
              <h3><?php echo $item["name"] ?></h3>
              <h5> <?php echo $item["price"] ?>$ </h5>
              <label>QTY: </label>
              <input type="number" name="qty" value="1" />
              <div class="btn_container">
                <button type="submit" name="order" value="<?php echo $item["ID"] ?>">Buy Now</button>
                <button type="submit" name="addToCart" value="<?php echo $item["ID"] ?>">Add to cart</button>
              </div>
            </form>
